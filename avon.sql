...
ALTER TABLE brands_tmp ADD CONSTRAINT brands_tmp_fk_countries_id 
FOREIGN KEY (countries_id) REFERENCES countries(countries_id);

ALTER TABLE brands_tmp ADD CONSTRAINT brands_tmp_fk_languages_id 
FOREIGN KEY (languages_id) REFERENCES languages(languages_id);
